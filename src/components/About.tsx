        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <div className="aspect-[3/4] bg-gradient-to-br from-navy to-navy-light rounded-md">
                {/* Placeholder for your image */}
              </div>
              <div className="absolute inset-0 border-2 border-navy rounded-md -translate-x-4 -translate-y-4 z-[-1]"></div>
            </div>
          </div>
